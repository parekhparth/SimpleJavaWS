 ...
 **/
@Path("products/v1")
@Service("distributedproductWebService")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class DistributedProductWebServiceImpl implements ProductWebService {
    private static final Logger logger = LoggerFactory.getLogger(DistributedProductWebServiceImpl.class);

    @Autowired
    @Qualifier("cassandracache")
